$( document ).ready( function () {
      ...
      fetch(url, {method: 'POST'})
        ...
        .then( function(res) {
          ...
          if (parseFloat(res.score) > 0.15) {
            ...
            // document.getElementById("happy-img").style.visibility="hidden";
            // document.getElementById("neu-img").style.visibility="hidden";
          } else if (parseFloat(res.score) >= 0.0 &&  parseFloat(res.score) <= 0.15) {
            // document.getElementById("angry-img").style.visibility="hidden";
            // document.getElementById("happy-img").style.visibility="hidden";
  ...
  aduck.initEntitiesButtom = function(){
    $( '.entities' ).click( function ( e ) {
      ...
      //log
      console.log( $( '.recognized-text' ).val());
      const url = "/entities?data=" + reconginized_text;
      fetch(url, {method: 'POST'})
        .then( response => response.json())
        .then( function(res) {
          console.log(typeof res);
